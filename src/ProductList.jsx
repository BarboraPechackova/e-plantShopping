...
function ProductList() {
    ...
    // Sync `addedToCart` with Redux cart to enable the button if an item is removed
    useEffect(() => {
        const updatedState = {};
        cart.forEach(item => {
            updatedState[item.name] = true;  // Mark items present in cart
        });
             ...
             <div className="navbar" style={styleObj}>
                <div className="tag">
                   ...
                   <a href="/" style={{textDecoration:'none'}}>
                        <div>
                            <h3 style={{color:'white'}}>Barb&apos;s Nursery</h3>
                            <i style={{color:'white'}}>Where plans come alive</i>
                        </div>
                        </a>
                    </div>
                </div>
                ...
                <div> <a href="#" onClick={(e)=>handlePlantsClick(e)} style={styleA}>Plants</a></div>
                 ...
                 <div className="navbar-container" style={{ position: "relative" }}>
                     <a href="#" onClick={(e) => { e.preventDefault(); setShowCart(true); }} style={{ position: 'relative', color: 'white', fontSize: '2rem', textDecoration: 'none' }}>
                        ...
                        {category.plants.map((plant, plantIndex) => (
                            <div className="product-card" key={plantIndex}>
                                ...
                                <button
                                    ...
                                    disabled={addedToCart[plant.name]} // Disable button if item is in cart
                                >
