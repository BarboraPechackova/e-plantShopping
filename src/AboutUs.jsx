...
function AboutUs() {
  return (
    <div className="about-us-container">
      ...
      <p className="about-us-description">Welcome to Barb&apos;s, where plans come alive!</p>
      <p className="about-us-content">
        At Barb&apos;s Nursery, we are passionate about bringing nature closer to you. Our mission is to provide a wide range of
